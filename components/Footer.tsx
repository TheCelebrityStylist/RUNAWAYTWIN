export default function Footer() {
  return (
    <footer className="border-t bg-white">
      <div className="mx-auto max-w-7xl px-6 py-12 grid gap-8 sm:grid-cols-4">
        <div className="space-y-2">
          <div className="text-lg font-display">RunwayTwin</div>
          <p className="text-sm text-rt-charcoal/80">
        ...
        <div className="text-sm space-y-2">
          ...
          <a href="/stylist" className="block hover:text-rt-gold">Stylist</a>
          <a href="/upgrade" className="block hover:text-rt-gold">Pricing</a>
          <a href="/blog" className="block hover:text-rt-gold">Blog</a>
        </div>
      ...
      <div className="mx-auto max-w-7xl px-6 pb-10 text-xs text-rt-charcoal/70">
